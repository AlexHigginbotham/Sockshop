...
resource "aws_security_group" "microservices-demo-staging-k8s" {
  ...
  tags = {
    yor_trace = "4c8a7a09-80e0-4285-bbde-6cbb854d1e9a"
  }
}
...
resource "aws_instance" "k8s-node" {
  ...
  tags = {
    yor_trace = "13779c7f-9c7d-40c2-86e9-5b4c34de0509"
  }
}
...
resource "aws_instance" "k8s-master" {
  ...
  tags = {
    yor_trace = "a0f3e662-e533-4da3-8ee8-b3aa89c8db0e"
  }
}
...
resource "aws_elb" "microservices-demo-staging-k8s" {
  ...
  tags = {
    yor_trace = "d8f81e7b-022c-482f-84b5-22d7394d5820"
  }
}
